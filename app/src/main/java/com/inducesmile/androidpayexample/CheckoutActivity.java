...
public class CheckoutActivity extends AppCompatActivity {
    ...
    //below code i have written to removed object value
    public double getRemainItemPrice(List<ProductObject>mProducts){
        double remainItemPrice=0;
        for(int i = 0; i < mProducts.size(); i++){
            ProductObject pObject = mProducts.get(i);
            remainItemPrice = remainItemPrice + pObject.getProductPrice();
        }
        return 0;
    }
}
